...
/*
  ...
  __AXI_SRAM_START[1] : stack_alloc_t *
...
#define ALLOC(a, s)      sa_alloc((a), (s))
#define FREE(a, p)       sa_free((a), (p))
...
void h743_reset_isr(){
  ...
  sa.free = ((u32) __AXI_SRAM_START) + 4096;
  sa.len  = 1 << 18;
  
  __AXI_SRAM_START[0] = (u32) &sched;
  __AXI_SRAM_START[1] = (u32) &sa;
...
#define SA          ((stack_alloc_t *) __AXI_SRAM_START[1])
...
u32 svchandler(u32 old_sp){
  ...
  transfer = (transfer_t *) ALLOC(SA, sizeof(transfer_t));
