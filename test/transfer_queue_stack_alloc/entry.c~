...
/*
  ...
  __AXI_SRAM_START[1] : transfer_t * (1)
  __AXI_SRAM_START[2] : transfer_t * (2)
  __AXI_SRAM_START[3] : transfer_t * (3)
  ...
  __AXI_SRAM_START[14] : task1 *
  __AXI_SRAM_START[15] : task2 *
  __AXI_SRAM_START[16] : task3 *
*/
...
void h743_reset_isr(){
  ...
  scheduler_t sched;
  task_t *elected;
  transfer_t transfer1, transfer2, transfer3;
  transfer_queue_t tq;
  ...
  __AXI_SRAM_START[1] = (u32) &transfer1;
  __AXI_SRAM_START[2] = (u32) &transfer2;
  __AXI_SRAM_START[3] = (u32) &transfer3;
  __AXI_SRAM_START[4] = (u32) &tq;
  __AXI_SRAM_START[12] = (u32) &dma_conf;
  __AXI_SRAM_START[13] = (u32) &dmamux_conf;
  __AXI_SRAM_START[14] = (u32) &task_task1;
  __AXI_SRAM_START[15] = (u32) &task_task2;
  __AXI_SRAM_START[16] = (u32) &task_task3;
...
#define TRANSFER1   ((transfer_t *) __AXI_SRAM_START[1])
#define TRANSFER2   ((transfer_t *) __AXI_SRAM_START[2])
#define TRANSFER3   ((transfer_t *) __AXI_SRAM_START[3])
#define TQ          ((transfer_queue_t *) __AXI_SRAM_START[4])
#define TASK1       ((task_t *) __AXI_SRAM_START[14])
#define TASK2       ((task_t *) __AXI_SRAM_START[15])
#define TASK3       ((task_t *) __AXI_SRAM_START[16])
...
u32 svchandler(u32 old_sp){
  ...
  if(old_elected == TASK1)
    transfer = TRANSFER1;
  else if(old_elected == TASK2)
    transfer = TRANSFER2;
  else
    transfer = TRANSFER3;
